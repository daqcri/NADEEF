...
/**
 * Abstract class RuleWriter represents the extension point of writing new
...
public abstract class RuleWriter {
     ...
     */
    public RuleWriter value(String value) {
     ...
     */
    public RuleWriter value(List<String> values) {
     ...
     */
    public RuleWriter table(List<String> tableNames) {
     ...
     */
    public RuleWriter table(String table1) {
     ...
     */
    public RuleWriter out(File outputPath) {
     ...
     */
    public RuleWriter name(String ruleName) {
