...
define([
    ...
    var svg,
        ...
        rainbow = [ "#00008B", "#8B0000", "#FF8C00", "BlueViolet", "Black", "#0000CD" ],
        onLineAddedHandlers = [];
    ...
    function start(r1, r2){
        table1 = !_.isNull(r1) ? new Table(r1, false, 0, 0) : null;
        table2 = !_.isNull(r2) ? new Table(r2, true, 400, 0) : null;
        render();
        bindEvent();
    }
